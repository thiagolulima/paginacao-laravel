...
$('#sa-success').click(function () {
    Swal.fire(
        {
            title: 'Tudo Certo!',
            text: 'Bem Adicionado com Sucesso!',
            type: 'success',
            confirmButtonClass: 'btn btn-confirm mt-2'
        }
    )
...
//Success Message
$('#sa-modeloAdicionado').click(function () {
  Swal.fire(
      {
          title: 'Tudo Certo!',
...
$('#sa-error').click(function () {
    Swal.fire({
        type: 'error',
        title: 'Desculpe...',
        text: 'Já existe um equipamento com o bem selecionado',
        confirmButtonClass: 'btn btn-confirm mt-2'
...
//Error Message
$('#sa-errorBem').click(function () {
  Swal.fire({
      type: 'error',
      title: 'Desculpe...',
      text: 'Por favor informe o bem',
      confirmButtonClass: 'btn btn-confirm mt-2'
    
  })
});
//Error Message
$('#sa-modeloErro').click(function () {
  Swal.fire({
      type: 'error',
      title: 'Desculpe...',
      text: 'Por favor informe a descrição e a marca.',
      confirmButtonClass: 'btn btn-confirm mt-2'
    
  })
});
//Error Message
$('#sa-grupoErro').click(function () {
   Swal.fire({
      type: 'error',
      title: 'Desculpe...',
      text: 'Por favor informe o grupo do equipamento',
      confirmButtonClass: 'btn btn-confirm mt-2'
